...
def get_shell():
    ...
    result = [
        ...
        "GRAY=\"\033[0;90m\";",
        "NC=\"\033[0m\";",
        "echo -n \'" + J8_1_MAIN_CODE + "\' > main1.c;",
        "echo -n \'" + testcase + "\' > testcase.in;",
        "echo -n \'" + answer + "\' > answer;",
        "gcc -o hw8-1 hw8-1.c main1.c >> /dev/null;",
        "if (( $? != 0 )); then",
...
def get_shell():
    ...
    result = [
        ...
        "GRAY=\"\033[0;90m\";",
        "NC=\"\033[0m\";",
        "echo -n \'" + J8_2_MAIN_CODE + "\' > main2.c;",
        "echo -n \'" + testcase + "\' > testcase.in;",
        "echo -n \'" + answer + "\' > answer;",
        "gcc -o hw8-2 hw8-2.c main2.c >> /dev/null;",
        "if (( $? != 0 )); then",
        "    echo -e \"Result: ${YELLOW}Compilation Error${NC}\";",
        "else",
